...
private:
    ...
    {
        const int majorSegments = 32; // Number of segments along the major circle
        const int minorSegments = 16; // Number of segments along the minor circle
        const float majorRadius = 0.7f; // Radius of the major circle
        const float minorRadius = 0.3f; // Radius of the minor circle
